...
let a = BigInt('35315308132206205938053219356172167184243234521329128101814628093311586402304', 16);
let G = BigInt('0x' + '', 16);
let P = BigInt('0x' + '', 16);
var sharedSecretText;
var hostname = '192.168.2.195';
console.log('-------------------');
let A = bigintCryptoUtils.modPow(G, a, P);
...
const req = https.request(options, res => {
    ...
    res.on('data', d => {
        ...
        let hellman = BigInt('0x' + respJson.hellman, 16);
