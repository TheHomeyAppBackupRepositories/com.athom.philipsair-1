...
let timer;
class device2 extends air_1.AirDevice {
    /**
     * onInit is called when the device is initialized.
     */
    async onInit() {
        this.log('device2 has been initialized');
     ...
     */
    async onAdded() {
        this.log('device2 has been added');
    }
    /**
    ...
    async onSettings({ oldSettings: {}, newSettings: {}, changedKeys: {} }) {
        this.log('device2 settings where changed');
    }
    /**
    ...
    async onRenamed(name) {
        this.log('device2 was renamed');
    }
    /**
     * onDeleted is called when the user deleted the device.
     */
    async onDeleted() {
        this.log('device2 has been deleted');
    }
}
